...
COMP = {
    ...
    "Vi": {
        ...
        "ornn_items_to_accept": ["AnimaVisage", "EternalWinter"],
        "zaun_items_to_accept": [],
        "level": 3,
        "max_amount_of_items": 3,
        "final_comp": True
    ...
    "Silco": {
        ...
        "secondary_items": ["SpearofShojin", "GiantSlayer", "Morellonomicon", "ArchangelsStaff"],
        "support_items_to_accept": [],
        "trait_items_to_accept": [],
        "ornn_items_to_accept": ["DeathfireGrasp", "GoldCollector", "GoldmancersStaff"],
    ...
    "Gangplank": {
        ...
        "ornn_items_to_accept": ["BlacksmithsGloves", "InfinityForce", "RocketPropelledFist"],
        "zaun_items_to_accept": [],
        "level": 2,
        "max_amount_of_items": 3,
        "final_comp": True
    ...
    "Aphelios": {
        ...
        "ornn_items_to_accept": ["BlacksmithsGloves", "RocketPropelledFist"],
        "zaun_items_to_accept": [],
        "level": 2,
        "max_amount_of_items": 3,
        "final_comp": True
    ...
    "Ekko": {
        ...
        "trait_items_to_accept": ["BilgewaterEmblem", "BruiserEmblem", "JuggernautEmblem", "NoxusEmblem",
                                  "ShurimaEmblem"],
        "ornn_items_to_accept": ["BlacksmithsGloves", "EternalWinter", "Hullcrusher", "InfinityForce", "ZhonyasParadox"],
    ...
    "Warwick": {
        ...
        "ornn_items_to_accept": ["DeathsDefiance", "GoldCollector", "Hullcrusher", "InfinityForce", "TrickstersGlass"],
